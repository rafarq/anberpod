...
def main() -> int:
    ...
    if args.render_dir:
        ...
        for route in routes:
            renderer.save(app.screen(route), args.render_dir / f"{route.value}.png")
        demo_result = Podcast(
        ...
        renderer.save(app.screen(), args.render_dir / "explore.png")
        ...
        if subscribed:
            ...
            renderer.save(app.screen(), args.render_dir / "podcast.png")
